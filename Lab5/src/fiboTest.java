...
public class fiboTest {
  ...
  public void testFibo(){
    ...
    try (BufferedReader reader = new BufferedReader(new FileReader("C:/Users/DELL/Documents/Алгоритмын шинжилгээ ба зохиомж/Lab5/src/TestCase.txt"))) {
  ...
  public void testKnap(){
    ...
    try (BufferedReader reader = new BufferedReader(new FileReader("C:/Users/DELL/Documents/Алгоритмын шинжилгээ ба зохиомж/Lab5/src/Knaptest.txt"))) {
      String line = reader.readLine();
      String[] tokens = line.split("-");
      reader.close();
